...
class ChatgptEndpoint extends Endpoint {
  ...
  Future<ByteData> generateJsonlFile(Session session) async {
      ...
      for(var saint in saints){
        data.add(
          {"custom_id":"${saint.id}","method":"POST","url":"/v1/chat/completions","body":{"model":"gpt-4o-mini-2024-07-18","messages":[{"role":"system","content":"Você é um especialista em extração estruturada de dados. Você receberá um texto não estruturado contando sobre a vida de um Santo da igreja católica e deverá convertê-lo na estrutura fornecida traduzindo para português brasileiro se for necessário"},{"role":"user","content":"Nome: ${saint.name} ou ${saint.religiousName}\n${saint.fullText}"}],"response_format":{"type":"json_schema","json_schema":{"name":"saint_extraction","strict":true,"schema":{"type":"object","properties":{"name":{"type":"string","description":"O nome de nascimento do santo"},"religiousName":{"type":["string","null"],"description":"O nome religioso do santo, caso não tenha é null"},"gender":{"type":["string","null"],"description":"O sexo do santo, deve retornar em","enum":["M","F"]},"title":{"type":["string","null"],"description":"título dado ao santo. É padroeiro de quê?"},"birth":{"type":"object","description":"Dados do santo referente ao seu nascimento","properties":{"period":{"type":["array","null"],"description":"Alguns santos não tem data exata de nascimento, por isso este campo pode conter o periodo provavel do nascimento, composto por data inicial e data final, mas de preferencia e caso existam dados suficientes, coloque somente uma data. Deve ser preenchida somente com numeros. Devem estar no formato yyyy/mm/dd com mm e dd sendo zero caso não existam dados para mês e dia. Caso a data seja antes de cristo deve colocar o sinal de menos antes da data, exemplo: -yyyy/mm/dd. A data não pode ser totalmente zerada, exemplo 0000/00/00","items":{"type":"string","description":"A(s) data(s) que compreende(m) o nascimento do santo. Deve estar no formato yyyy/mm/dd com mm e dd sendo zero caso não existam dados para mês e dia. Deve ser preenchida somente com numeros. Caso a data seja antes de cristo deve colocar o sinal de menos antes da data, exemplo: -yyyy/mm/dd. A data não pode ser totalmente zerada, exemplo 0000/00/00"}},"country":{"type":["string","null"],"description":"País de nascimento do santo se disponível e null caso não haja dados sobre o país"},"city":{"type":["string","null"],"description":"Cidade de nascimento do santo se disponível e null caso não haja dados sobre a cidade"},"details":{"type":["string","null"],"description":"Mais detalhes sobre o nascimento  se disponível e null caso não haja dados sobre os detalhes"},"correspondentActualCountry":{"type":["string","null"],"description":"As vezes algum santo nasceu muito tempo atrás e o país não corresponde a geografia atual, aqui deve ser colocado o país que corresponde atualmente"}},"required":["period","country","city","details","correspondentActualCountry"],"additionalProperties":false},"death":{"type":"object","description":"Dados do santo referente ao seu falecimento","properties":{"period":{"type":["array","null"],"description":"Aqui podem ser colocadas datas possíveis da morte do santo, por isso este campo pode conter o periodo provavel do nascimento, ou seja, data inicial e final, mas de preferencia e caso existam dados suficientes, coloque somente uma data.  Deve ser preenchida somente com numeros. Devem estar no formato yyyy/mm/dd com mm e dd sendo zero(0) caso não existam dados para mês e dia. Caso a data seja antes de cristo deve colocar o sinal de menos antes da data, exemplo: -yyyy/mm/dd. A data não pode ser totalmente zerada, exemplo 0000/00/00","items":{"type":"string","description":"A(s) data(s) que compreende(m) a da morte do santo. Deve estar no formato yyyy/mm/dd com mm e dd sendo zero(0) caso não existam dados para mês e dia. Deve ser preenchida somente com numeros. Caso a data seja antes de cristo deve colocar o sinal de menos antes da data, exemplo: -yyyy/mm/dd. A data não pode ser totalmente zerada, exemplo 0000/00/00"}},"country":{"type":["string","null"],"description":"País onde morreu o santo se disponível e null caso não haja dados sobre o país"},"city":{"type":["string","null"],"description":"Cidade de morte do santo se disponível e null caso não haja dados sobre a cidade"},"details":{"type":["string","null"],"description":"Mais detalhes sobre a morte do santo se disponível e null caso não haja dados sobre os detalhes"},"correspondentActualCountry":{"type":["string","null"],"description":"As vezes algum santo morreu muito tempo atrás e o país não corresponde a geografia atual, aqui deve ser colocado o país que corresponde atualmente"},"isMartir":{"type":["boolean"],"description":"Se o santo foi morto por causa de sua fé se não houver dados sobre deve ser false"},"causeOfdeath":{"type":["string","null"],"description":"Como este santo morreu  se disponível e null caso não haja dados sobre a causa da morte"}},"required":["period","country","city","details","correspondentActualCountry","isMartir","causeOfdeath"],"additionalProperties":false},"family":{"type":"object","description":"Dados dos familiares do santo, caso não haja nenhum dado, colocar null","properties":{"father":{"type":["string","null"],"description":"Nome do pai do santo"},"mother":{"type":["string","null"],"description":"Nome da mãe do santo"},"numberOfSiblings":{"type":["number","null"],"description":"Quantidade de irmãos biologicos e adotados pelo pai e mãe"}},"required":["father","mother","numberOfSiblings"],"additionalProperties":false},"veneration":{"type":"object","description":"Dados relacionados a veneração pelo santo, caso não haja coolocar null","properties":{"celebrationDate":{"type":["array","null"],"description":"Dia(s) em que se celebra o santo, deve ter o formato dd/mm.","items":{"type":"string","description":"Datas que compreendem aos dias em que se celebra o santo. deve ter o formato dd/mm."}},"legacy":{"type":["string","null"],"description":"Qual o legado que este santo deixou para nós? Para quem ele mais rezou, protegeu. Que lição nos deixou?"}},"required":["celebrationDate","legacy"],"additionalProperties":false},"academicTraining":{"type":["array","null"],"description":"Formação academica do santo","items":{"type":"string","description":"Deve ser o nome da formação"}},"ecclesiasticalHierarchy":{"type":["array","null"],"description":"Hierarquia do santo na vida cristã, por exemplo: Leigo, consagrado, padre, bispo, diacono, frei, freira, frade e etc.","items":{"type":"object","properties":{"hiearchyName":{"type":"string","description":"nome dado a hierarquia Leigo, consagrado, padre, bispo, diacono, frei, freira, frade e etc."},"details":{"type":["string","null"],"description":"Detalhes a respeito da hierarquia deste santo"}},"required":["hiearchyName","details"],"additionalProperties":false}},"cononizationDate":{"type":["string","null"],"description":"A data da cononização do santo. Deve estar no formato yyyy/mm/dd com mm e dd sendo zero caso não existam dados. A data não pode estar totalmente zerada, exemplo: 0000/00/00"},"beatificationDate":{"type":["string","null"],"description":"A data da beatificação do santo. Deve estar no formato yyyy/mm/dd com mm e dd sendo zero caso não existam dados. A data não pode estar totalmente zerada, exemplo: 0000/00/00"},"religiousEvents":{"type":["array","null"],"description":"Todos os eventos descritos que são importantes na vida do santo, como ordenção, batismo etc. principalmente eventos religiosos e espirituais","items":{"type":"object","properties":{"year":{"type":["number","null"],"description":"Ano em que aconteceu o evento"},"event":{"type":["string","null"],"description":"Descrição do que foi o evento no pretérito perfeito do indicativo"}},"required":["year","event"],"additionalProperties":false}},"miracles":{"type":["array","null"],"description":"Todos os milagres, prodígios e ações divinas feitas através do santo, caso não tenha colocar null","items":{"type":"object","properties":{"miracleName":{"type":"string","description":"Tipo do milagre, por exemplo: bilocação, cura, chagas e etc"},"details":{"type":["string","null"],"description":"Detalhes do milgare, onde como ocorreu e outros detalhes importantes"}},"required":["miracleName","details"],"additionalProperties":false}},"quotations":{"type":["array","null"],"description":"Citações de texto ou de fala dita ou escrita pelo santo. Deve ser transcrita exatamente e literalmente como foi dita ou escrita. Não coloque aspas","items":{"type":"object","properties":{"quote":{"type":"string","description":"Transcrição literal de exatamente o que foi dito ou escrito"},"context":{"type":["string","null"],"description":"Contexto em que foi dita, para quem, onde, porque"},"reference":{"type":["string","null"],"description":"Dados precisos da onde está escrito ou onde foi dito: livro, pagina, ano, local."}},"required":["quote","context","reference"],"additionalProperties":false}},"prayers":{"type":["array","null"],"description":"Oração ou orações feita pelo santo, ou que é rezada para/por ele. Deve ser uma transcrição literal da oração, ou seja, deve ser a oração em si","items":{"type":"string"}},"summary":{"type":["string","null"],"description":"Resumo do texto destacando caracteristicas da vida e religiosidade do santo, deve ser colocados o máximo de detalhes possível do texto"}},"required":["name","religiousName","gender","title","birth","death","family","veneration","academicTraining","ecclesiasticalHierarchy","cononizationDate","beatificationDate","religiousEvents","miracles","quotations","prayers","summary"],"additionalProperties":false}}}}}
        );
      }
